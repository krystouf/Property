...
ReactDOM.render(React.createElement(Form_1.Form, null), document.getElementById("app"));
    ...
    Form.prototype.render = function () {
        ...
        return (React.createElement("div", null,
            React.createElement("form", { onSubmit: this.handleSubmit },
                ...
                React.createElement("select", { name: "selectArr", onChange: this.handleChange },
                    React.createElement("option", { value: "" }, "DESTINATION"),
                    arrival),
                React.createElement("div", { className: "onoffswitch" },
                    React.createElement("input", { type: "checkbox", name: "chooseAlgo", className: "onoffswitch-checkbox", id: "myonoffswitch", onChange: this.handleChange }),
...
exports.Form = Form;
function createOptions(list, keyName) {
    var options = [];
    var uniqueArray = removeDuplicates(list, keyName);
    for (var i = 0; i < uniqueArray.length - 1; i++) {
        var value = uniqueArray[i][keyName];
        options.push(React.createElement("option", { key: i, value: value }, value));
    }
    return options;
}
...
const removeDeepFromMap = __webpack_require__(30);
const toDeepMap = __webpack_require__(31);
const validateDeep = __webpack_require__(32);
